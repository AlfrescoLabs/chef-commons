...
# This recipe also makes the assumption that the awscli is already installed
# The installation recipe was removed from this recipe to allow either or both
# to be called.
